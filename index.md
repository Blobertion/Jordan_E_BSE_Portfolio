...
# Second Milestone
My Second milestone was the construction of the actual maze itself. I realized that my previous design was based on having an aditional servo motor so I had to redesign half of the blueprint. Despite that, it ended up rather well. I implemented a sort of progression system into the second half which was inspired by the Mario Games. In the earlier Mario titles, progression works by introducing a very simple concept that is unique to that level. The concept is then expanded upon and grown into something totally unique. I decided to do something similar on a much more micro level with my magnets and tight ropes. I also built the outside stand for the maze inspired by the original video. However, the original didn't have dimensions for this framework so I had measure the pixel counts to get measurements. Even with this sucess, I'm still concerned aboout a few things. I think the tight rope sections might be much too hard, they are for me atleast. In order to compensate I think I'm going to need to make the phone control very fine. I hope it works. 
